...
import { Game2049 } from "@/components/Game2049";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "Play.g2049" });

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: {
      canonical: locale === "en" ? "/play/2049" : `/${locale}/play/2049`,
      languages: {
        en: "/play/2049",
        et: "/et/play/2049",
      },
...
export default async function Game2049Page({ params }: PageProps) {
  const { locale } = await params;
