...
import { MagiBird } from "@/components/MagiBird";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "Play.magibird" });

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: {
      canonical: locale === "en" ? "/play/magibird" : `/${locale}/play/magibird`,
      languages: {
        en: "/play/magibird",
        et: "/et/play/magibird",
      },
...
export default async function MagiBirdPage({ params }: PageProps) {
  const { locale } = await params;
